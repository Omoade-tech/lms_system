                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#viewBookModal-<?= $book['id'] ?>">Edit</button>
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#deleteBookModal-<?= $book['id'] ?>">Delete</button>
                                    </td>
                                </tr>
                                            ...
                                            <form action="/lms_system/controllers/BookController.php" method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="title-<?= $book['id'] ?>"
                                                            name="title" value="<?= htmlspecialchars($book['title']) ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="author-<?= $book['id'] ?>" class="form-label">Author</label>
                                                        <input type="text" class="form-control" id="author-<?= $book['id'] ?>"
                                                            name="author" value="<?= htmlspecialchars($book['author']) ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="isbn-<?= $book['id'] ?>" class="form-label">ISBN</label>
                                                        <input type="text" class="form-control" id="isbn-<?= $book['id'] ?>"
                                                            name="isbn" value="<?= htmlspecialchars($book['isbn']) ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="copies-<?= $book['id'] ?>" class="form-label">Available
                                                            Copies</label>
                                                        <input type="number" class="form-control" id="copies-<?= $book['id'] ?>"
                                                            name="available_copies" value="<?= htmlspecialchars($book['available_copies']) ?>" required>
                                                    </div>
                                                </div>
